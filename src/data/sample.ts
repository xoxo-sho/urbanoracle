...
export const sampleTransportStations: TransportStation[] = [
  { id: "ts-1", name: "新宿駅", lat: 35.6896, lng: 139.7006, type: "train", dailyPassengers: 775_386, lines: ["JR山手線", "中央線", "小田急線", "京王線", "都営新宿線", "丸ノ内線", "都営大江戸線"] },
  { id: "ts-2", name: "池袋駅", lat: 35.7295, lng: 139.7109, type: "train", dailyPassengers: 558_623, lines: ["JR山手線", "東武東上線", "西武池袋線", "丸ノ内線", "有楽町線", "副都心線"] },
  { id: "ts-3", name: "東京駅", lat: 35.6812, lng: 139.7671, type: "train", dailyPassengers: 462_589, lines: ["東海道新幹線", "JR山手線", "中央線", "京葉線", "丸ノ内線"] },
  { id: "ts-4", name: "横浜駅", lat: 35.4657, lng: 139.6224, type: "train", dailyPassengers: 423_651, lines: ["JR東海道線", "京急線", "東急東横線", "相鉄線", "市営地下鉄"] },
  { id: "ts-5", name: "品川駅", lat: 35.6284, lng: 139.7387, type: "train", dailyPassengers: 374_601, lines: ["東海道新幹線", "JR山手線", "京急線"] },
  { id: "ts-6", name: "渋谷駅", lat: 35.658, lng: 139.7016, type: "train", dailyPassengers: 366_128, lines: ["JR山手線", "東急東横線", "銀座線", "半蔵門線", "副都心線"] },
  { id: "ts-7", name: "大宮駅", lat: 35.9065, lng: 139.6237, type: "train", dailyPassengers: 257_839, lines: ["東北新幹線", "JR京浜東北線", "宇都宮線", "埼京線", "ニューシャトル"] },
  { id: "ts-8", name: "北千住駅", lat: 35.7497, lng: 139.8049, type: "train", dailyPassengers: 246_855, lines: ["JR常磐線", "東武スカイツリーライン", "千代田線", "日比谷線", "つくばエクスプレス"] },
  { id: "ts-9", name: "上野駅", lat: 35.7141, lng: 139.7774, type: "train", dailyPassengers: 187_532, lines: ["東北新幹線", "JR山手線", "京浜東北線", "銀座線", "日比谷線"] },
  { id: "ts-10", name: "秋葉原駅", lat: 35.6984, lng: 139.7731, type: "train", dailyPassengers: 172_486, lines: ["JR山手線", "京浜東北線", "総武線", "日比谷線", "つくばエクスプレス"] },
];
